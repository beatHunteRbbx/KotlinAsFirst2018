...
"""
        ...
        centerFile("input/my_test.txt", "temp.txt")
        assertFileContent("temp.txt",
                "                   бГ, ббичбэавв -- ббвЁ: ьаббаабб\n" +
                        "   бЬъвб --- ВАЁБВБИВ -- БЬЪВБ  ббичбэавв - вб, АНБЦАВЦ - ВБВВЫХББВ\n" +
                        "                               хаг  бг\n" +
                        "ХАГ, БД; вбввЫХббВ  ндш -- бтраЖУбвЬХ БД --- ндш --- ИАЙВАЦ --- БЬЪВБ,")
